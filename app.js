...
const sessionOptions = {
  name: 'superblogssession', // Don't use default session cookie name.
  secret: 'something about awesome blogs', // Change it!!! The secret is used to hash the session with HMAC.
