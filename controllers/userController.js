...
// controller for directing the user to the registeration page
...
// controller for getting the details of the user profile
...
userController.deletePost = async (req, res, next) => {
  try {
    ...
    req.session.flash = { type: 'success', text: 'Your account and blogs were successfully deleted.' }
